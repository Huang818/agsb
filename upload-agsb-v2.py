...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "huang"         # 用户名
UUID = "f90201f6-de66-4609-8754-9d01975ed6de"                     # UUID，留空则自动生成
PORT = 49999                   # Vmess端口，留空或0则自动生成
DOMAIN = "iu.xiaohuang001.ggff.net"                   # 域名，留空则自动获取
CF_TOKEN = "{"AccountTag":"f6bafc63594aa099c6f60f751611c047","TunnelSecret":"Ap79C+2H91ma3HRuly8P+Tyzwr+Y2RYrYZxbZK7exZ8=","TunnelID":"15ad4084-6b2a-4aa4-a14c-ca009e7eb136","Endpoint":""}"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
